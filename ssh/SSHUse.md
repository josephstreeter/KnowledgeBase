...
```
The command will return the following output if successful.
```
...
Hi josephstreeter! You've successfully authenticated, but GitHub does not provide shell access.
